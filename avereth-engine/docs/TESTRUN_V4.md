...
- **„at the second one“:** Das zweite Tier war nie Kämpfer (nur gehört). Die Engine schoss auf das einzige Ziel (Core #29: einziger Gegner = automatisches Ziel). GLM erzählte das stimmig: Die graue Ratte springt in den Schuss.
